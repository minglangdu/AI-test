...
const std::vector<int> sizes = {52, 3, 0};
...
const double NOVELTY_REWARD = 7;
const double PROXIMITY_REWARD = 2; // reward for getting close to another agent
const double PROXIMITY_RADIUS = 125;
